...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_ANTAIO
    APT(SP_ANTAIO,          SK_FIGHTING,        1),
    APT(SP_ANTAIO,          SK_SHORT_BLADES,   -1),
    APT(SP_ANTAIO,          SK_LONG_BLADES,    -1),
    APT(SP_ANTAIO,          SK_AXES,           -1),
    APT(SP_ANTAIO,          SK_MACES_FLAILS,   -1),
    APT(SP_ANTAIO,          SK_POLEARMS,       -1),
    APT(SP_ANTAIO,          SK_STAVES,         -1),
    APT(SP_ANTAIO,          SK_SLINGS,         -1),
    APT(SP_ANTAIO,          SK_BOWS,           -1),
    APT(SP_ANTAIO,          SK_CROSSBOWS,      -1),
    APT(SP_ANTAIO,          SK_THROWING,        0),
    APT(SP_ANTAIO,          SK_ARMOUR,         -1),
    APT(SP_ANTAIO,          SK_DODGING,        -1),
    APT(SP_ANTAIO,          SK_STEALTH,        -3),
    APT(SP_ANTAIO,          SK_STABBING,       -3),
    APT(SP_ANTAIO,          SK_SHIELDS,         0),
    APT(SP_ANTAIO,          SK_TRAPS,          -3),
    APT(SP_ANTAIO,          SK_UNARMED_COMBAT,  0),
    APT(SP_ANTAIO,          SK_SPELLCASTING,   -2),
    APT(SP_ANTAIO,          SK_CONJURATIONS,   -1),
    APT(SP_ANTAIO,          SK_HEXES,          -1),
    APT(SP_ANTAIO,          SK_CHARMS,         -1),
    APT(SP_ANTAIO,          SK_SUMMONINGS,     -1),
    APT(SP_ANTAIO,          SK_NECROMANCY,      0),
    APT(SP_ANTAIO,          SK_TRANSLOCATIONS, -1),
    APT(SP_ANTAIO,          SK_TRANSMUTATIONS, -1),
    APT(SP_ANTAIO,          SK_FIRE_MAGIC,     -1),
    APT(SP_ANTAIO,          SK_ICE_MAGIC,      -1),
    APT(SP_ANTAIO,          SK_AIR_MAGIC,      -1),
    APT(SP_ANTAIO,          SK_EARTH_MAGIC,     1),
    APT(SP_ANTAIO,          SK_POISON_MAGIC,   -1),
    APT(SP_ANTAIO,          SK_INVOCATIONS,     0),
    APT(SP_ANTAIO,          SK_EVOCATIONS,     -1),
